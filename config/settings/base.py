...
)  # (sme_atualizacao_cadastral_apps/config/settings/base.py - 3 = sme_atualizacao_cadastral_apps/)
APPS_DIR = ROOT_DIR.path("sme_atualizacao_cadastral_apps")
...
MIGRATION_MODULES = {"sites": "sme_atualizacao_cadastral_apps.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sme_atualizacao_cadastral_apps.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""SME-AMCom""", "sme-amcom@example.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "sme_atualizacao_cadastral_apps.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "sme_atualizacao_cadastral_apps.users.adapters.SocialAccountAdapter"
